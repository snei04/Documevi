...
// El componente ahora acepta una función 'onFileChange' para comunicarse con el padre
const FileUpload = ({ onFileChange }) => {
  ...
  const handleFileChange = (e) => {
    if (e.target.files && e.target.files[0]) {
      ...
      setText(file.name); // Muestra el nombre del archivo seleccionado
      onFileChange(file); // Informamos al componente padre sobre el nuevo archivo
    }
  };
