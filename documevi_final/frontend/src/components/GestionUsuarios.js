...
// Importamos tanto el Guardián como el Hook de permisos
import PermissionGuard from './auth/PermissionGuard';
import { usePermissions } from '../hooks/usePermissions';

const GestionUsuarios = () => {
    // Instanciamos el hook para poder usarlo en la lógica del componente
    ...
    useEffect(() => {
        ...
        const fetchRoles = async () => {
            try {
                ...
                // Si el usuario no tiene permiso para ver roles, esto podría fallar.
                // Es mejor manejarlo de forma silenciosa en la consola.
